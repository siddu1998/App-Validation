...
def parsing_camrea_annotations(image,camera_annotations):
    ...
    for index,row in camera_annotations.iterrows():
        if row["image_name"]==image:
            ...
            camera_cordinates_utm=utm.from_latlon(camera_cordinates_lat,camera_cordinates_lon)
    return (camera_cordinates_utm[0],camera_cordinates_utm[1])
...
def camera_to_sign(camera_cordinates,distancs_tuple,right_or_left):
    ...
    #print(camera_cordinates)
    #return (camera_cordinates[0]-20,camera_cordinates[1]-10) 
    #print(distancs_tuple)   
    #return (camera_cordinates[0]+distancs_tuple[1],camera_cordinates[1]-distancs_tuple[0])
    #gtsv/non-interstate/straight/state_route_2
    #gps=utm.to_latlon(camera_cordinates[0]-distancs_tuple[0], camera_cordinates[1]-distancs_tuple[1],16, 'N')
    gps=utm.to_latlon(camera_cordinates[0]-distancs_tuple[0], camera_cordinates[1]-distancs_tuple[1],16, 'N')
    print(distancs_tuple[0],",",distancs_tuple[1],",",gps[0],",",gps[1])
